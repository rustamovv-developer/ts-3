      ...
      <div className="container">
        <div className="footer__top">
          <div className="footer__card">
            <Link href={"/"} className="footer__box">
              <Image src={img} alt="footer__logo" className="footer__img" />
          ...
          <div className="footer__card">
            ...
            <div className="footer__exam">
              <Image src={img1} alt="facebook" className="footer__image" />
              <Image src={img2} alt="twitter" className="footer__image" />
            </div>
          </div>
          <div className="footer__card">
        ...
        <div className="footer__end">
          ...
          <Image src={images} alt="footer__img" className="footer__images" />
        </div>
      </div>
    </footer>
  );
